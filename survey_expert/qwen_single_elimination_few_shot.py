"""
Pairwise elimination tournament for astronomical image scoring (Qwen Few-Shot).
...
- Qwen selects the more interesting image (without generating an explanation).
...
RESULT_TEMPLATE = os.path.join(RESULTS_DIR, "qwen_single_elimination_few_shot_990_run{}.csv")
NUM_CORES = 20
    ...
    with open(checkpoint_file, "a", newline="", encoding="utf-8") as f:
        ...
        for match_number, pair_images in matches:
            ...
            try:
                ...
                contents.append({"type": "text", "text": "The following images are examples of INTERESTING targets worth selecting:"})
                for b64 in interesting_b64s:
                    if b64:
                        contents.append({"type": "image_url", "image_url": {"url": f"data:image/png;base64,{b64}"}})

                contents.append({"type": "text", "text": "The following images are examples of BORING targets that should NOT be selected:"})
                ...
                contents.append({
                    ...
                    "text": (
                        ...
                        "Choose the image that is more scientifically interesting and return the winner."
                    )
                })
                ...
                # Winner gets 1 point. No Reasoning is gathered for Qwen.
                writer.writerow([
                    round_number,
                    match_number,
                    winner,
...
def run_experiment(run_idx, api_key, all_images, artifact_b64s, interesting_b64s, boring_b64s):
                ...
                with open(cp, "r", encoding="utf-8") as f:
                    ...
                    for row in reader:
                        ...
                        if fname in scores:
                            ...
                            reasons[fname] = ""  # No reasoning column filled
    ...
    with open(results_file, "w", newline="", encoding="utf-8") as f:
        ...
        for img in sorted(scores, key=scores.get, reverse=True):
            ...
            writer.writerow([
                img, score, "",  # Empty string for Reasoning
...
if __name__ == "__main__":
    ...
    if not api_key:
        raise ValueError("API Key (OPENROUTER_API_KEY or JB_API_KEY) not found in environment.")
