...
The model is prompted with a few shot of artifact, interesting, and boring examples.
"""
import os
import csv
import time
...
RESULT_TEMPLATE = "ai_csvs/gemini_grid_likert_few_shot_990_run{}.csv"
NUM_CORES = 20
...
def process_batches(args):
    worker_id, batches, api_key, artifact_uris, interesting_uris, boring_uris, progress_queue = args
