"""
Pairwise elimination tournament for astronomical image scoring (No-Shot).
...
RESULT_TEMPLATE = "ai_csvs/gemini_single_elimination_no_shot_990_run{}.csv"
NUM_CORES = 20
...
if __name__ == "__main__":
    ...
    print(f"Done. Ready with {len(artifact_uris)} artifact examples.\n")
