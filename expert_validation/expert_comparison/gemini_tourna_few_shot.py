...
RESULT_TEMPLATE = "ai_csvs/gemini_tournament_few_shot_990_run{}.csv"
        ...
        for match_number, pair_images in matches:
            ...
            try:
                ...
                contents = [
                    ...
                    *artifact_files,
                    "The following images are examples of INTERESTING targets worth keeping:",
                    *interesting_files,
                    "The following images are examples of BORING targets that should be filtered out:",
                    *boring_files,
                    (
