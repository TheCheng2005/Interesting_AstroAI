"""
Evaluating astronomical images in a 4x4 Grid using Qwen (Few-Shot).
...
RESULT_TEMPLATE = os.path.join(RESULTS_DIR, "qwen_grid_likert_few_shot_990_run{}.csv")
NUM_CORES = 20
...
SYSTEM_INSTRUCTION = (
    ...
    "Your task:\n"
    "1. Select any images that are scientifically interesting (skip artifacts, boring targets, and noisy frames).\n"
...
def process_batches(args):
    worker_id, batches, api_key, artifact_b64s, interesting_b64s, boring_b64s, progress_queue = args
    client = OpenAI(
        api_key=api_key,
